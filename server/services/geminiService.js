...
const generateImageFromPrompt = async (prompt) => {
  try {
    ...
    const generationPrompt = `Generate only the SVG code for the following concept: "${prompt}". Do not include any other text, explanations, or markdown formatting. The output must be a single, valid SVG code block.`;
